...
public class EntityRelationshipTest {
    ...
    void oneToOnePersist() {
        ...
        credential.setId("habib");
        credential.setEmail("habib@gmail.com");
        credential.setPassword("rahasia");
        entityManager.persist(credential);

        User user = new User();
        user.setId("habib");
        user.setName("Fathin Musthafa");
    ...
    void oneToOneFind() {
        ...
        User user = entityManager.find(User.class, "habib");
        Assertions.assertNotNull(user.getCredential());

        Assertions.assertEquals("habib@gmail.com", user.getCredential().getEmail());
    ...
    void fetch() {
        ...
        // kalo pake Lazy jika 2 tabel di operasikan semua (product & brand) maka akan ada 2 proses query hibernate
        // kalo pake default (eager) hanya 1 proses query hibernate
